...
4)	Open your .bash_profile (typically in your home directory, located on Mac in /Users/<user name>/ ), 
...
6)	Make the Boost libraries and build tool acessible, add the following lines to your .bash_profile:
...
8)	Navigate to the folder containing the WMFire model, e.g. /my_rhessys_versions/RHESSys/util/FIRE
...
11)	Compile RHESSys with the additional argument: make wmfire='T'

12)	If changes are made to the fire model, repeat steps 9-12
