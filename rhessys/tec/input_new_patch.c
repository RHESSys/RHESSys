									 ...
									 struct	 patch_object *patch)
{
	...
	dtmp  = getIntWorldfile(&paramCnt,&paramPtr,"family_ID","%d",patch[0].family_ID,1);
	if (abs(dtmp - NULLVAL) >= ONE)  patch[0].family_ID = dtmp;
    ...
    /* input the below ground litter pool */
    ltmp = getDoubleWorldfile(&paramCnt,&paramPtr,"litter_cs.litr1c_bg","%lf",patch[0].litter_cs.litr1c_bg,1);
	if (fabs(ltmp - NULLVAL) >= ONE)  patch[0].litter_cs.litr1c_bg = ltmp;
	ltmp = getDoubleWorldfile(&paramCnt,&paramPtr,"litter_ns.litr1n_bg","%lf",patch[0].litter_ns.litr1n_bg,1);
	if (fabs(ltmp - NULLVAL) >= ONE)  patch[0].litter_ns.litr1n_bg = ltmp;
	ltmp = getDoubleWorldfile(&paramCnt,&paramPtr,"litter_cs.litr2c_bg","%lf",patch[0].litter_cs.litr2c_bg,1);
	if (fabs(ltmp - NULLVAL) >= ONE)  {
		patch[0].litter_cs.litr2c_bg = ltmp;
		patch[0].litter_ns.litr2n_bg = patch[0].litter_cs.litr2c_bg / CEL_CN;
		}
	ltmp = getDoubleWorldfile(&paramCnt,&paramPtr,"litter_cs.litr3c_bg","%lf",patch[0].litter_cs.litr3c_bg,1);
	if (fabs(ltmp - NULLVAL) >= ONE)  {
		patch[0].litter_cs.litr3c_bg = ltmp;
		patch[0].litter_ns.litr3n_bg = patch[0].litter_cs.litr3c_bg / CEL_CN;
		}
	ltmp = getDoubleWorldfile(&paramCnt,&paramPtr,"litter_cs.litr4c_bg","%lf",patch[0].litter_cs.litr4c_bg,1);
	if (fabs(ltmp - NULLVAL) >= ONE)  {
		patch[0].litter_cs.litr4c_bg = ltmp;
	...
	patch[0].litter_cs.litr1c_hr_snk_bg = 0.0; //below ground litter carbon
