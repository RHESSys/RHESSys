...
/*																*/
/*	execute_csv_yearly_output_event - outputs yearly data			*/
/*																*/
/*	NAME														*/
/*	execute_csv_yearly_output_event - outputs yearly data 	.		*/
/*																*/
									...
									struct	world_output_file_object	*outfile)
{
	...
	/*--------------------------------------------------------------*/
	void output_csv_yearly_basin(
		struct	basin_object *,
		struct	date,
		FILE	*);
	
	void output_csv_yearly_hillslope( int,
		struct	hillslope_object *,
		struct	date,
		FILE	*);
	
	void output_csv_yearly_zone( 	int, int,
		struct	zone_object *,
		struct	date,
		FILE	*);
	
	void output_csv_yearly_patch(	int, int, int,
		struct	patch_object *,
		struct	date,
		FILE	*);
	
	void output_csv_yearly_canopy_stratum(
		int, int, int, int,
	...
	if ((command_line[0].b != NULL) || (command_line[0].h != NULL) ||
		...
		return;
} /*end execute_csv_yearly_output_event*/
