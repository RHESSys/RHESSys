...
/*																*/
/*	execute_csv_daily_output_event - outputs daily data			*/
/*																*/
/*	NAME														*/
/*	execute_csv_daily_output_event - outputs daily data 	.		*/
/*																*/
									   ...
									   struct	world_output_file_object	*outfile)
{
	...
	/*--------------------------------------------------------------*/
	void output_csv_basin(
		int,
		struct	basin_object *,
		struct	date,
		FILE	*);
	
	void output_csv_hillslope(	int,
		struct	hillslope_object *,
		struct	date,
		FILE	*);
	
	void output_csv_zone(	int, int,
		struct	zone_object *,
		struct	date,
		FILE	*);
	...
	if ((command_line[0].b != NULL) || (command_line[0].h != NULL) ||
		...
		return;
} /*end execute_csv_daily_output_event*/
