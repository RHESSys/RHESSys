...
/*																*/
/*	execute_hourly_output_event - outputs hourly data			*/
/*																*/
/*	NAME														*/
/*	execute_hourly_output_event - outputs hourly data 	.		*/
/*																*/
...
/*	specifications to specific files, for hourly info			*/
									...
									struct	world_output_file_object	*outfile)
{
	...
	void	output_hourly_zone(	int basinID, int hillID,
	...
	if ((command_line[0].b != NULL) || (command_line[0].h != NULL) ||
		...
		return;
} /*end execute_hourly_output_event*/
