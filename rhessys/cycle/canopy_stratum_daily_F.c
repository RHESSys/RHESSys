							   ...
							   struct date 			            current_date)
{
  ...
  void	update_shadow_strata(
	...
	double deltaT;
	double netpabs_shade, netpabs_sunlit, flnr_sunlit, flnr_shade;
...
//		printf("Debugging understory et and pet,stratum PET, stratum transpiration sat and unsat, stratum evaporation: %lf\t%lf\t%lf\t%lf\t%lf\t%lf\n",patch[0].fire.understory_et,patch[0].fire.understory_pet, stratum[0].PET,stratum[0].transpiration_sat_zone, stratum[0].transpiration_unsat_zone,stratum[0].evaporation);
    ...
    update_shadow_strata(world, zone, patch, stratum, shadow_strata, command_line, current_date);
  }
	...
	if ((command_line[0].output_flags.monthly == 1) &&
		...
		if (stratum[0].acc_month.minNSC == -999)
		...
		stratum[0].acc_month.live_crootc += stratum[0].cs.live_crootc;
		stratum[0].acc_month.dead_crootc += stratum[0].cs.dead_crootc;
		stratum[0].acc_month.stemc += stratum[0].cs.live_stemc+stratum[0].cs.dead_stemc;
		stratum[0].acc_month.live_stemc += stratum[0].cs.live_stemc;
		stratum[0].acc_month.dead_stemc += stratum[0].cs.dead_stemc;
	...
	if ((command_line[0].output_flags.yearly == 1) &&
		...
		stratum[0].acc_year.live_crootc += stratum[0].cs.live_crootc;
		stratum[0].acc_year.dead_crootc += stratum[0].cs.dead_crootc;
		stratum[0].acc_year.stemc += stratum[0].cs.live_stemc+stratum[0].cs.dead_stemc;
		stratum[0].acc_year.live_stemc += stratum[0].cs.live_stemc;
		stratum[0].acc_year.dead_stemc += stratum[0].cs.dead_stemc;
