							  ...
							  struct 	date current_date)
{
	...
	if (stratum[0].rain_stored > 0){
		...
		* (stratum[0].NO3_stored + patch[0].hourly[0].NO3_throughfall);
	    ...
	    NH4_stored = (stratum[0].rain_stored) / (stratum[0].rain_stored + rain_throughfall) 
		* (stratum[0].NH4_stored + patch[0].hourly[0].NH4_throughfall);
	    NH4_throughfall = (rain_throughfall) / (stratum[0].rain_stored + rain_throughfall) 
		* (stratum[0].NH4_stored + patch[0].hourly[0].NH4_throughfall);
		...
		* (stratum[0].NO3_stored + patch[0].hourly[0].NO3_throughfall); 
		...
		NH4_stored = (stratum[0].rain_stored) 
	      	/ (stratum[0].rain_stored + rain_throughfall) 
		* (stratum[0].NH4_stored + patch[0].hourly[0].NH4_throughfall);
