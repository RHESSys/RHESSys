			...
			struct command_line_object *command_line)
{
	...
	fprintf(outfile,"%s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s\n" ,
		"day",
		"month",
		"year",
		"basinID",
	...
	fprintf(outfile,
		...
		"mresp",
		"leaf_mresp",
		"gresp", "gs_sunlit", "gs_shade", "assim_sunlit","assim_shade","trans_sunlit","trans_shade",
		"psn_to_cpool","age","leaf_age1","leaf_age2", "root_depth","gwseasonday","lfseasonday","gsi", "nlimit",
