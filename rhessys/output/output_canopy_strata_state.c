								   ...
								   FILE	*outfile)
{
	...
	/*--------------------------------------------------------------*/
	fprintf(outfile , "\n            ");
	fprintf(outfile , "%-30d %s"        , canopy_strata[0].ID                       , "canopy_strata_ID");
	fprintf(outfile , "\n            ");
	fprintf(outfile , "%-30d %s"        , canopy_strata[0].defaults[0][0].ID        , "veg_parm_ID");
	fprintf(outfile , "\n            ");
	...
	fprintf(outfile , "\n            ");
	fprintf(outfile , "%-30d %s"        , (canopy_strata[0].epv.wstress_days)       , "epv.wstress_days");
	fprintf(outfile , "\n            ");
	...
	fprintf(outfile , "\n            ");
	fprintf(outfile , "%-30d %s"        , canopy_strata[0].num_base_stations        , "canopy_strata_n_basestations");
	for (i=0; i < canopy_strata[0].num_base_stations; i++){
		fprintf(outfile,"\n            ");
		fprintf(outfile,"%-30d %s",canopy_strata[0].base_stations[i][0].ID,"canopy_strata_basestation_ID");
	}
	return;
