									 ...
									 FILE *outfile)
{
	...
	/*------------------------------------------------------*/
		...
		/*------------------------------------------------------*/
		/*	if has algae, output  variables		*/
		/*------------------------------------------------------*/
		if(stratum[0].defaults[0][0].epc.veg_type == ALGAE) {
			fprintf(outfile,
				"%d %d %d %d %d %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %d %lf %d %d %lf %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf \n",
				current_date.day,
				current_date.month,
				current_date.year,
				basinID,
		...
		/*------------------------------------------------------*/
		/*	if does not have algae, output algae variables as NaN	*/
		/*------------------------------------------------------*/
		} else {			
		
			fprintf(outfile,
				"%d %d %d %d %d %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %d %lf %d %d %lf %d %lf %lf %lf %lf %lf %lf %lf %s %s %s %s %s %s %s %s %s %s %s \n",
				current_date.day,
				current_date.month,
				current_date.year,
				basinID,
