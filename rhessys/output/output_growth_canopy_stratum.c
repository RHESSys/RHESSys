									 ...
									 FILE *outfile)
{
	...
	fprintf(outfile,
		"%d %d %d %d %d %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf \n",
		current_date.day,
		current_date.month,
		current_date.year,
		basinID,
		...
		(stratum[0].cdf.leaf_night_mr+stratum[0].cdf.leaf_day_mr)*1000.0,
		stratum[0].cdf.total_gr*1000.0,
		stratum[0].gs_sunlit * 1000.0,
		stratum[0].gs_shade * 1000.0,
		stratum[0].cdf.assim_sunlit * 1000.0,
		stratum[0].cdf.assim_shade * 1000.0,
		stratum[0].cdf.transpiration_rate_sunlit*1000,
		stratum[0].cdf.transpiration_rate_shade*1000,
		stratum[0].cdf.psn_to_cpool * 1000.0,
		stratum[0].cs.age,
		stratum[0].cs.leafc_age1,
		stratum[0].cs.leafc_age2,
