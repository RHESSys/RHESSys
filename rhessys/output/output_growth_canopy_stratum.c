									 ...
									 FILE *outfile)
{
	...
	fprintf(outfile,
		"%d %d %d %d %d %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf \n",
		current_date.day,
		current_date.month,
		current_date.year,
		basinID,
		...
		(stratum[0].cs.reprodc + stratum[0].cs.reprodc_store + stratum[0].cs.reprodc_transfer)* 1000.0,
		(stratum[0].ns.reprodn + stratum[0].ns.reprodn_store + stratum[0].ns.reprodn_transfer)* 1000.0,
		stratum[0].cs.seedc * 1000.0,
		stratum[0].ns.seedn * 1000.0,
