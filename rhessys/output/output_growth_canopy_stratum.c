									 ...
									 FILE *outfile)
{
	...
	fprintf(outfile,
		"%ld %ld %ld %d %d %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n",
		current_date.day,
		current_date.month,
		current_date.year,
		basinID,
		...
		stratum[0].phen.gwseasonday*1.0,
		stratum[0].phen.lfseasonday*1.0,
		stratum[0].phen.gsi,
		stratum[0].ns.nlimit,
		stratum[0].cdf.fleaf, stratum[0].cdf.froot, stratum[0].cdf.fwood, stratum[0].ndf.actual_N_uptake*1000.0,
		stratum[0].ndf.potential_N_uptake*1000.0,
