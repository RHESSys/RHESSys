							  ...
							  FILE *outfile)
{
	...
	/*------------------------------------------------------*/
		...
		if(stratum[0].defaults[0][0].epc.veg_type == ALGAE) {
			fprintf(outfile,
			"%d %d %d %d %d %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %d %lf %lf %lf \n",
			current_date.day,
			current_date.month,
			current_date.year,
			basinID,
		...
		/*------------------------------------------------------*/
			...
			fprintf(outfile,
			"%d %d %d %d %d %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %d %s %s %s \n",
			current_date.day,
			current_date.month,
			current_date.year,
			basinID,
