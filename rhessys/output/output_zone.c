					...
					FILE *outfile)
{
	...
	/*------------------------------------------------------*/
	fprintf(outfile,
		"%ld %ld %ld %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n",
		current_date.day,
		current_date.month,
		current_date.year,
		basinID,
		...
		zone[0].w_horizon,
			...
			zone[0].CO2, zone[0].lai, zone[0].ndep_NO3, zone[0].total_stemc, zone[0].height); 
	return;
} /*end output_zone*/
