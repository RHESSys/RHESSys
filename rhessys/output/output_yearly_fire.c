							  ...
							  FILE *outfile)
{
	...
	fprintf(outfile,
		...
		(stratum[0].fe.acc_year.m_cwdc_to_atmos) / stratum[0].fe.acc_year.length,
		(stratum[0].fe.acc_year.m_cwdn_to_atmos) / stratum[0].fe.acc_year.length,
		...
		(stratum[0].fe.acc_year.understory_c_consumed) / stratum[0].fe.acc_year.length,
