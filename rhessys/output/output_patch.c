					 ...
					 FILE *outfile)
{
	...
	/*------------------------------------------------------*/
		...
		if(patch[0].scm_defaults[0][0].ID != 0) {
			check = fprintf(outfile,"%d %d %d %d %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n",
							current_date.day,
							current_date.month,
							current_date.year,
							basinID,
							...
							patch[0].snowpack.water_equivalent_depth*1000.0,
							patch[0].snow_melt*1000.0,
							(patch[0].transpiration_sat_zone*1000.0),
							(patch[0].transpiration_unsat_zone)*1000.0,
							patch[0].Qin_total * 1000.0,
							patch[0].Qout_total * 1000.0,
							apsn * 1000.0,
							patch[0].rootzone.S,
							...
							patch[0].litter.rain_stored*1000.0,
							litterS,
							patch[0].area, (patch[0].PET)*1000.0, 
							alai, 
							patch[0].base_flow*1000.0, 
							patch[0].streamflow*1000.0, 
							1000.0*(zone[0].rain+zone[0].snow),
							patch[0].recharge, 
							...
							patch[0].Kup_diffuse,
							patch[0].Lup,
							patch[0].Kdown_direct_subcanopy,
							patch[0].Kdown_diffuse_subcanopy,
							patch[0].Ldown_subcanopy, 
							patch[0].Kstar_canopy,
							patch[0].snowpack.Kstar_direct,
							patch[0].snowpack.Kstar_diffuse,
							patch[0].Lstar_canopy,
							patch[0].Lstar_snow,
							patch[0].Lstar_soil, 
							patch[0].wind,
							patch[0].windsnow,
							...
							patch[0].snowpack.K_reflectance,
							patch[0].Kstar_soil,
							patch[0].Kdown_direct_bare,
							patch[0].Kdown_diffuse_bare,
							patch[0].exfiltration_unsat_zone,
							patch[0].snowpack.Rnet/86.4,
							patch[0].snowpack.Q_LE/86.4,
							patch[0].snowpack.Q_H/86.4,
							...
							patch[0].snowpack.energy_deficit,
							patch[0].snowpack.surface_age,
							patch[0].surface_Qin*1000.0, // ADDED FOR SCMs - surface inflow - mm
							patch[0].Qin*1000.0, // ADDED FOR SCMs - surface inflow - mm
							patch[0].surface_Qout*1000.0, // ADDED FOR SCMs - surface inflow - mm
							patch[0].Qout*1000.0, // ADDED FOR SCMs - surface outflow -  mm
							patch[0].scm_ave_height*1000.0); // ADDED FOR SCMs - surface outflow -  mm
						if (check <= 0) {
							fprintf(stdout, "\nWARNING: output error has occured in output_patch");
						}
		...
		/*------------------------------------------------------*/				
				...
				check = fprintf(outfile,"%d %d %d %d %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %s\n",
							current_date.day,
							current_date.month,
							current_date.year,
							basinID,
							...
							patch[0].surface_Qout*1000.0, // ADDED FOR SCMs - surface inflow - mm
							patch[0].Qout*1000.0, // ADDED FOR SCMs - surface outflow -  mm
							"NaN"); // ADDED FOR SCMs - surface outflow -  mm
						if (check <= 0) {
							fprintf(stdout, "\nWARNING: output error has occured in output_patch");
						}
			}
