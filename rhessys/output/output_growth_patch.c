							...
							FILE *outfile)
{
	...
	check = fprintf(outfile,
		"%ld %ld %ld %ld %d %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n",
		current_date.day,
		current_date.month,
		current_date.year,
		basinID,
		...
		patch[0].ndf.net_mineralized*1000, patch[0].sat_NO3*1000, patch[0].sat_NH4*1000, patch[0].sat_DON, patch[0].sat_DOC,
		patch[0].cap_rise_ratio, patch[0].unsat_drain_ratio, patch[0].water_drop_ratio, patch[0].water_rise_ratio
