							...
							FILE *outfile)
{
	...
	/*------------------------------------------------------*/
		...
		if(patch[0].scm_defaults[0][0].ID != 0) {
			check = fprintf(outfile,
				"%ld %ld %ld %ld %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n",
				current_date.day,
				current_date.month,
				current_date.year,
				basinID,
				...
				patch[0].grazing_Closs * 1000.0,
				patch[0].area,
				patch[0].surface_DOC_Qin*1000,  // SCM OUTPUT VARIABLE ... * 1000 to convert kg/m2 to g/m2
				patch[0].surface_DOC_Qout*1000,  // SCM OUTPUT VARIABLE ... * 1000 to convert kg/m2 to g/m2
				patch[0].surface_DOC_settled*1000,  // SCM OUTPUT VARIABLE ... * 1000 to convert kg/m2 to g/m2
				patch[0].surface_DON_Qin*1000,  // SCM OUTPUT VARIABLE ... * 1000 to convert kg/m2 to g/m2
				patch[0].surface_DON_Qout*1000,  // SCM OUTPUT VARIABLE ... * 1000 to convert kg/m2 to g/m2
				patch[0].surface_DON_settled*1000,  // SCM OUTPUT VARIABLE ... * 1000 to convert kg/m2 to g/m2
				patch[0].surface_NH4_Qin*1000,  // SCM OUTPUT VARIABLE ... * 1000 to convert kg/m2 to g/m2
				patch[0].surface_NH4_Qout*1000,  // SCM OUTPUT VARIABLE ... * 1000 to convert kg/m2 to g/m2
				patch[0].surface_NO3_Qin*1000,  // SCM OUTPUT VARIABLE ... * 1000 to convert kg/m2 to g/m2
				patch[0].surface_NO3_Qout*1000);  // SCM OUTPUT VARIABLE ... * 1000 to convert kg/m2 to g/m2
			if (check <= 0) {
				fprintf(stdout, "\nWARNING: output_growth error has occured in output_growth_patch");
			}		
		...
		/*------------------------------------------------------*/
			...
			check = fprintf(outfile,
				"%ld %ld %ld %ld %d %d %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %s %lf %lf %s %lf %lf %lf %lf\n",
				current_date.day,
				current_date.month,
				current_date.year,
				basinID,
