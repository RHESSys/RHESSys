...
/*																*/
/*	output_csv_yearly_basin - creates output files objects.		*/
/*																*/
/*	NAME														*/
/*	output_csv_yearly_basin - outputs current contents of a basin.			*/
/*																*/
/*	SYNOPSIS													*/
							 ...
							 FILE *outfile)
{
	...
	check = fprintf(outfile,
		"%d,%d,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%d\n",
		current_date.year,
		basin[0].ID,
