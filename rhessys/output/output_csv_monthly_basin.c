...
/*																*/
/*	output_csv_monthly_basin - creates output files objects.		*/
/*																*/
/*	NAME														*/
/*	output_csv_monthly_basin - outputs current contents of a basin.			*/
/*																*/
/*	SYNOPSIS													*/
							 ...
							 FILE *outfile)
{
	...
	if (check <= 0) {
		fprintf(stdout,
			"\nWARNING: output error has occured in output_csv_monthly_basin");
	}
	/*--------------------------------------------------------------*/
