											 ...
											 
{
	...
	if (LWP_predawn !=  9999.0) {
		...
		/*--------------------------------------------------------------*/
		/* The following is possible code for supporting competition.	*/
		/* HOWEVER, it currently causes too much water stress in 	*/
		/* shallow rooted species if there is also deeply rooted 	*/
		/* vegetation on the same patch. 				*/
		/*--------------------------------------------------------------*/
