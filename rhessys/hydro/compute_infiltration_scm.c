...
/*	PROGRAMMER NOTES					*/
/*								*/
/*		Modified so it maxes out at infiltration rate			*/
/*		specified in scm default files - based on design std.	*/
/*--------------------------------------------------------------*/
#include <stdio.h>
#include <math.h>
#include "rhessys.h"
...
double	compute_infiltration_scm(int verbose_flag,
							 double z,
							 double S,
							 ...
							 double infiltration_rate)
{
	...
	/*--------------------------------------------------------------*/
	/* limit computed infiltration rate to max allowable by design */
	/*--------------------------------------------------------------*/
	if(infiltration > infiltration_rate*duration)
		infiltration = infiltration_rate * duration;
