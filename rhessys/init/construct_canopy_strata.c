													 ...
													 struct	default_object	*defaults)
{
	...
	default_object_ID = getIntWorldfile(&paramCnt, &paramPtr, "veg_parm_ID","%d",1,1);
	...
	canopy_strata[0].rootzone.depth = getDoubleWorldfile(&paramCnt,&paramPtr,"rootzone.depth","%lf",0.1,1);
