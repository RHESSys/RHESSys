													 ...
													 struct	default_object	*defaults)
{
	...
	canopy_strata[0].acc_year.frootc = 0.0;
	canopy_strata[0].acc_year.live_crootc = 0.0;
	canopy_strata[0].acc_year.dead_crootc = 0.0;
	canopy_strata[0].acc_year.stemc = 0.0;
	canopy_strata[0].acc_year.live_stemc = 0.0;
	canopy_strata[0].acc_year.dead_stemc = 0.0;
	canopy_strata[0].acc_year.cwdc = 0.0;
	canopy_strata[0].acc_year.cwdc_bg = 0.0;
	canopy_strata[0].acc_year.gpsn = 0.0;
	canopy_strata[0].acc_year.mr = 0.0;
	canopy_strata[0].acc_year.gr = 0.0;
	...
	canopy_strata[0].acc_year.redefine_stemc_harvest = 0.0;
	canopy_strata[0].acc_year.redefine_stemc_remain = 0.0;
	...
	canopy_strata[0].acc_month.frootc = 0.0;
	canopy_strata[0].acc_month.live_crootc = 0.0;
	canopy_strata[0].acc_month.dead_crootc = 0.0;
	canopy_strata[0].acc_month.stemc = 0.0;
	canopy_strata[0].acc_month.live_stemc = 0.0;
	canopy_strata[0].acc_month.dead_stemc = 0.0;
	...
	canopy_strata[0].acc_month.mr = 0.0;
	canopy_strata[0].acc_month.gr = 0.0;
	...
	canopy_strata[0].acc_month.redefine_stemc_harvest = 0.0;
	canopy_strata[0].acc_month.redefine_stemc_remain = 0.0;
